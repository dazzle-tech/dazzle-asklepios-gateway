...
import com.dazzle.asklepios.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    private static final String UPDATED_LOGIN = "testuser";

    private static final Long DEFAULT_ID = 1L;

    private static final String DEFAULT_EMAIL = "johndoe@localhost";
    private static final String UPDATED_EMAIL = "testuser@localhost";
    ...
    void updateUserExistingEmail() throws Exception {
        ...
        anotherUser.setEmail("testuser@localhost");
