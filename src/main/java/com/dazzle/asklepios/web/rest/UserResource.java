 ...
 * <p>
 * This class accesses the {@link com.dazzle.asklepios.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
     ...
     */
    @GetMapping("/users")
    @PreAuthorize("hasAnyAuthority('" + AuthoritiesConstants.ADMIN + "', '" + AuthoritiesConstants.PRACTITIONERS_EDIT + "')")
